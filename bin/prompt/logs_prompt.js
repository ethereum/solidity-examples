...
exports.logsPrompt = {
    ...
    ].concat(utils_1.SEPARATOR).concat(utils_1.NAV_CHOICES)
};
exports.logsMenu = function () { return __awaiter(_this, void 0, void 0, function () {
    var selected;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, utils_1.prompt(exports.logsPrompt)];
            case 1:
                selected = _a.sent();
                switch (selected.logs) {
                    case "latest_test":
                        try {
                            ...
                            logger_1.default.error("Latest testlog could not be read: " + err.message);
                        }
                        break;
                    case "latest_perf":
                        try {
                    ...
                    case "latest_perf_diff":
                        if (!logs_1.printLatestDiff()) {
                            logger_1.default.error("Missing entries: Perf must have been run at least two times.");
                        }
                        break;
                ...
                return [4 /*yield*/, exports.logsMenu()];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
